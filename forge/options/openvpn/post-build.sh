#!/bin/bash
# post-build.sh -- prove the OpenVPN for Android APK in the image is byte-identical to the fetched one (a
...
app_post_build openvpn "$AOSP/vendor/lineage/prebuilts/openvpn" OpenVPN
