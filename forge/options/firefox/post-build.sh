#!/bin/bash
# post-build.sh -- prove the Firefox APK in the image is byte-identical to the fetched one (a
...
app_post_build firefox "$AOSP/vendor/lineage/prebuilts/firefox" Firefox
