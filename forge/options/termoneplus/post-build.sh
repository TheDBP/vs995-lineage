#!/bin/bash
# post-build.sh -- prove the TermOne Plus APK in the image is byte-identical to the fetched one (a
...
app_post_build termoneplus "$AOSP/vendor/lineage/prebuilts/termoneplus" TermOnePlus
