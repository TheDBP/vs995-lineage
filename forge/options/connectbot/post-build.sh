#!/bin/bash
# post-build.sh -- prove the ConnectBot APK in the image is byte-identical to the fetched one (a
...
app_post_build connectbot "$AOSP/vendor/lineage/prebuilts/connectbot" ConnectBot
