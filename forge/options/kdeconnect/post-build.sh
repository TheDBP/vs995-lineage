#!/bin/bash
# post-build.sh -- prove the KDE Connect APK in the image is byte-identical to the fetched one (a
...
app_post_build kdeconnect "$AOSP/vendor/lineage/prebuilts/kdeconnect" KDEConnect
